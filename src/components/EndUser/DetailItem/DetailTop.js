                ...
                <div className='detail-infor'>
                    ...
                    <div className='detail-infor-cart counter'>
                        <div className='d-flex counter-box'>
                            <span className='btn btn-danger' onClick={addToCardOnClick}><ion-icon name="cart-outline"></ion-icon>Thêm vào giỏ hàng</span>
                        </div>

                        <button className="button" style={{ height: "50px" }}>
